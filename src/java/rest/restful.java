...
public class restful extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      String[] metodos_permitidos = {"listado","consulta"};
          ...
          if(check_uri){
              if(this.metodo != null){
                  if(this.metodo.equals("nuevo")){
                      ...
                      if(fields==true){
                          if(this.control.altaDB(this.tabla, columnas_query.toString().replace("[", "").replace("]", ""), valores_query.toString().replace("[", "'").replace("]", "'").replace(",", "','").replace(" ",""))){
